import { DepGraphData } from '@khulnasoft/dep-graph';
...
/* Test Result
 * this data is returned on a `vulnmap test` for supported project types
...
// defining only what is used by @vulnmap/fix
// add more as needed
