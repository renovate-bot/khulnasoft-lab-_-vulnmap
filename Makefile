...
prepack: $(BINARY_OUTPUT_FOLDER)/version
	@echo 'Initiating build for Vulnmap binaries with Node version: node$(PKG_NODE_VERSION)'
...
$(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap.tgz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
...
$(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-alpine: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	...
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-alpine.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-linux: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node$(PKG_NODE_VERSION)-linux-x64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-linux
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-linux.sha256
...
$(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-linux-arm64: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node$(PKG_NODE_VERSION)-linux-arm64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-linux-arm64 --no-bytecode
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-linux-arm64.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-macos: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node$(PKG_NODE_VERSION)-macos-x64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-macos
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-macos.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-macos-arm64: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node$(PKG_NODE_VERSION)-macos-arm64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-macos-arm64 --no-bytecode
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-macos-arm64.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-win.exe: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node$(PKG_NODE_VERSION)-win-x64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-win.exe
	powershell $(WORKING_DIR)/cliv2/scripts/sign_windows.ps1 $(BINARY_RELEASES_FOLDER_TS_CLI) vulnmap-win.exe
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-win.exe.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-for-docker-desktop-darwin-x64.tar.gz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	./docker-desktop/build.sh darwin x64
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-for-docker-desktop-darwin-x64.tar.gz.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-for-docker-desktop-darwin-arm64.tar.gz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	./docker-desktop/build.sh darwin arm64
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/vulnmap-for-docker-desktop-darwin-arm64.tar.gz.sha256
...
pack-binary-wrapper: build-binary-wrapper
	@echo "-- Packaging tarball ($(BINARY_OUTPUT_FOLDER)/vulnmap.tgz)"
