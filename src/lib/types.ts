...
import { legacyCommon as legacyApi } from '@khulnasoft/cli-interface';
import { SEVERITY } from './vulnmap-test/legacy';
import { FailOn } from './vulnmap-test/common';
...
export interface PolicyOptions {
  'ignore-policy'?: boolean; // used in vulnmap/policy lib
  'trust-policies'?: boolean; // used in vulnmap/policy lib
  'policy-path'?: string;
  loose?: boolean;
}
...
export enum SupportedCliCommands {
  ...
  about = 'about',
  help = 'help',
  // config = 'config', // TODO: cleanup `$ vulnmap config` parsing logic before adding it here
