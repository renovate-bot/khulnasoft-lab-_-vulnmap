 ...
 */
export const iacTestTitle = colors.info.bold('Vulnmap Infrastructure as Code');

/**
 * Progress indication message while files are tested.
 */
export const spinnerMessage = colors.info(
  'Vulnmap testing Infrastructure as Code configuration issues.',
);
...
export const customRulesReportMessage = colors.info(
  "Please note that your custom rules will not be sent to the Vulnmap platform, and will not be available on the project's page.",
);
