...
import {
  IacTestError,
  mapIacTestError,
} from '../../../vulnmap-test/iac-test-result';
...
function vulnerabilitiesToIacIssues(
  ...
  return vulnerabilities.map((v) => {
    ...
    return {
      ...
      documentation: v.rule.documentation, // only works for rules available on vulnmap.khulnasoft.com
...
// TODO: add correct mapping to our packageManger name (will probably be done in `vulnmap-iac-test`)
