...
const debugLog = createDebugLogger('vulnmap-iac');
...
export const policyEngineUrl = `https://static.vulnmap.khulnasoft.com/cli/iac/test/v${policyEngineReleaseVersion}/${policyEngineFileName}`;
