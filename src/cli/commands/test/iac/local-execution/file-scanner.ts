...
import { SEVERITIES } from '../../../../../lib/vulnmap-test/common';
...
export class FailedToBuildPolicyEngine extends CustomError {
  constructor(message?: string) {
    ...
    this.userMessage =
      'We were unable to run the test. Please run the command again with the `-d` flag and contact support@khulnasoft.khulnasoft.com with the contents of the output';
  }
}
