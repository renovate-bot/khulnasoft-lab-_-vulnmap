...
export class UnsupportedFileTypeError extends CustomError {
  constructor(fileType: string) {
    ...
    this.userMessage = `Unable to process the file with extension ${fileType}. Supported file extensions are tf, yml, yaml & json.\nMore information can be found by running \`vulnmap iac test --help\` or through our documentation:\nhttps://support.vulnmap.khulnasoft.com/hc/en-us/articles/360012429477-Test-your-Kubernetes-files-with-our-CLI-tool\nhttps://support.vulnmap.khulnasoft.com/hc/en-us/articles/360013723877-Test-your-Terraform-files-with-our-CLI-tool`;
  }
}
