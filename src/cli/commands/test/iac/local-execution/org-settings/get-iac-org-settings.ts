...
import { Payload } from '../../../../../../lib/vulnmap-test/types';
...
export class FailedToGetIacOrgSettingsError extends CustomError {
  constructor(message?: string) {
    ...
    this.userMessage =
      'We failed to fetch your organization settings, including custom severity overrides for infrastructure-as-code policies. Please run the command again with the `-d` flag and contact support@khulnasoft.khulnasoft.com with the contents of the output.';
  }
}
