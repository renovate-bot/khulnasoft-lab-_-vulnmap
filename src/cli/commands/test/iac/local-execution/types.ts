...
import { SEVERITY } from '../../../../../lib/vulnmap-test/common';
import {
  AnnotatedIssue,
  IgnoreSettings,
  TestResult,
...
export interface PolicyMetadata {
  ...
  subType: string;
  title: string;
  documentation?: string; // e.g. "https://security.vulnmap.khulnasoft.com/rules/cloud/VULNMAP-CC-XXX",
...
> & {
  ...
  rules?: string;
  // Enables Vulnmap Cloud custom rules
  'custom-rules'?: boolean;
  'vulnmap-cloud-environment'?: string;
  // Tags and attributes
  'project-tags'?: string;
...
export enum IaCErrorCodes {
  ...
  // vulnmap-iac-test non-fatal errors
