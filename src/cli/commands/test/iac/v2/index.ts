...
async function prepareTestConfig(
  ...
  // relative and let vulnmap-iac-test figure them out according to what it
  ...
  const vulnmapCloudEnvironment = getFlag(options, 'vulnmap-cloud-environment');
