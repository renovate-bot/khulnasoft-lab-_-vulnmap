...
export default async function log4shell(...args: MethodArgs): Promise<void> {
  console.log(
    'Please note this command is for already built artifacts. To test source code please use `vulnmap test`.',
  );
...
function displayRemediation(exploitType: ExploitType) {
  switch (exploitType) {
    case 'Log4Shell':
      ...
      \t- https://security.vulnmap.khulnasoft.com/vuln/VULNMAP-JAVA-ORGAPACHELOGGINGLOG4J-2314720
      \t- https://vulnmap.khulnasoft.com/blog/log4shell-remediation-cheat-sheet/\n`);
      break;

    case 'DoS':
      console.log(`\nWe recommend fixing this vulnerability by upgrading to a later version. To learn more about this vulnerability, see:
      \t- https://security.vulnmap.khulnasoft.com/vuln/VULNMAP-JAVA-ORGAPACHELOGGINGLOG4J-2321524\n`);
      break;
