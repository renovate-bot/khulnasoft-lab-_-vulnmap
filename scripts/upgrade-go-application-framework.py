...
def get_latest_commit_sha():
    url = f"https://api.github.com/repos/khulnasoft-lab/go-application-framework/commits"
    headers = {
...
def upgrade_go_application_framework(commit_sha):
    subprocess.run(['go', 'get', '-u', f'github.com/khulnasoft-lab/go-application-framework@{commit_sha}'], cwd='./cliv2', check=True)
