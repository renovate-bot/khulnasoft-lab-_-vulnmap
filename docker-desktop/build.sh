...
build_name="vulnmap-for-docker-desktop-${platform}-${arch}"
...
# Include entrypoint.
cp ./docker-desktop/src/vulnmap-mac.sh "${build_dir}"

# Include Vulnmap CLI build.
...
# Create Vulnmap CLI for Docker Desktop build
#
